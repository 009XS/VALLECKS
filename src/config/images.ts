 ...
 * 
 * Abstraction layer to centralize static image paths.
 * These references should be changed to 'static/img/optimized/*.webp' 
 * once the WebP assets are generated and placed in the optimized folder.
 */
export const images = {
  // Attraction images
